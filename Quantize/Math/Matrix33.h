...
namespace  Furiosity
{
    ...
    public:
        ...
        /// Diagonal init. Matrix33(1) will give you indentity
        ///
        /// @val A value to
        ///
        Matrix33(float val)
        {
            m11 = val;  m12 = 0.0f; m13 = 0.0f;
            m21 = 0.0f; m22 = val;  m23 = 0.0f;
            m31 = 0.0f; m32 = 0.0f; m33 = val;
        }
        ...
        ///
        inline void SetTransform(const Vector2& up, const Vector2& right, const Vector2& translation)
        {
            m11 = right.x;          m12 = right.y;          m13 = 0.0f;
            m21 = up.x;             m22 = up.y;             m23 = 0.0f;
            m31 = translation.x;    m32 = translation.y;    m33 = 1.0f;
