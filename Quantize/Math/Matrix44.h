...
namespace Furiosity
{
    ...
    public:
        ...
        {
            Vector4 res(f[0] * vec.v[0] + f[4] * vec.v[1] + f[8]  * vec.v[2] + f[12] * vec.v[3],
                        f[1] * vec.v[0] + f[5] * vec.v[1] + f[9]  * vec.v[2] + f[13] * vec.v[3],
                        f[2] * vec.v[0] + f[6] * vec.v[1] + f[10] * vec.v[2] + f[14] * vec.v[3],
                        f[3] * vec.v[0] + f[7] * vec.v[1] + f[11] * vec.v[2] + f[15] * vec.v[3]);
            return res;
        }
